...
class Carrito{
    ...
    save(o){        
        ...
        const escribirProductosCarrito = async () => {
            try{
        ...
        let respuesta = escribirProductosCarrito().then((res) => {return res})
        return respuesta
    ...
    updateById(n, o){
        ...
        let response = actualizarProductosCarrito().then((res) => {return res})
        return response
